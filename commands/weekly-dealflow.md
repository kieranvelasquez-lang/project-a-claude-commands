...
First, read the corrections memory file at `~/.claude/memory/weekly-dealflow-corrections.md` using the Read tool. If it exists, load all corrections into context:
...
Write the file to `~/Desktop/weekly-dealflow-v1.html` with this structure:
...
Write the file to `~/Desktop/weekly-dealflow-v2.html` with the same structure but:
...
Use Bash to run:
- `open ~/Desktop/weekly-dealflow-v1.html`
- `open ~/Desktop/weekly-dealflow-v2.html` (if V2 was created)
...
- If the corrections file doesn't exist yet, create it at `~/.claude/memory/weekly-dealflow-corrections.md` with this header:
